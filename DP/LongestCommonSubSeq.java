...
public class LongestCommonSubSeq {
    //  Recursive_______________________________
    static int lcs(String str1, String str2,int  n, int m) {
        if(n==0||m==0) return 0;

        if(str1.charAt(n-1)==str2.charAt(m-1)) return  lcs(str1, str2, n-1, m-1)+1;
        else{
    ...
    static int lcsMemoization(String str1, String str2, int n, int m,  int[][]dp){
        if(n==0|| m==0) return 0;
