...
public class Q1RealQuestionIgotinNQT {
    ...
    public static void main(String[] args) {
        ...
        int n1 = 3;
        System.out.println(question(arr1, n1)); // Output: 1 (3 present in every chunks)
        
        int[] arr2 = {3, 9, 4,     5, 2, 3,     7, 9, 2,     3}; 
        int n2 = 3;
        System.out.println(question(arr2, n2)); // Output: 0 (3 not present in every chunk)
