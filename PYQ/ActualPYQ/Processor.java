...
// minTime = minimum of all currentMax values
//         What does a “split” mean?

// Each split represents one possible assignment of work.

// At split index i:

// Friend 1 gets first i tasks → prefix[i]

// Friend 2 gets remaining tasks → suffix[i]

// This is one candidate solution.

// Why TOTAL TIME = max(time1, time2)?

// Imagine:

// Friend 1 finishes in 4 sec

// Friend 2 finishes in 10 sec

// Can the work finish in 4 sec? ❌
// Because Friend 2 is still working.

// Can the work finish in 10 sec? ✅
// Yes, because by then both are done.


// Why do we want the MINIMUM of currentMax?

// Because the goal is:

// Finish all tasks as early as possible
